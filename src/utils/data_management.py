...
def train_valid_generator(data_dir, IMAGE_SIZE, BATCH_SIZE, do_data_augmentation):
    ...
    valid_generator = valid_datagenerator.flow_from_directory(
        directory = data_dir, subset = "validation", shuffle = False, **dataflow_kwargs)
    ...
    if do_data_augmentation:
        ...
        logging.info("Augmentation is used for training")
    else:
        train_datagenerator = valid_datagenerator
        logging.info("Augmentation is not used for training")

    train_generator = train_datagenerator.flow_from_directory(
        directory = data_dir, subset="training", shuffle=True, **dataflow_kwargs)
