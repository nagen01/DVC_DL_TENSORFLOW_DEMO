...
logging.basicConfig(filename=os.path.join(logs_dir,"running_logs.log"), level=logging.INFO, 
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.info(f"Stage {Stage} completed, callbacks created and saved")
